smlua_text_utils_dialog_replace(DIALOG_000, 1, 5, 30, 200, ("Thanks for downloading\
my hack.  This level is\
very extreme and  I\
would recommend\
practicing with savestates\
before doing attempts.\
This was originally\
supposed to be part\
of a full hack, but I \
scrapped the level,\
so I turned it into a \
mini hack. This has 5 \
stars. Good luck, and I\
hope you have fun."))
...
smlua_text_utils_dialog_replace(DIALOG_150, 1, 5, 30, 200, ("Why did you come in\
here? Here I am, taking a\
nice relaxing bath in my\
poison, and you just come\
in and ruin it."))

smlua_text_utils_dialog_replace(DIALOG_151, 1, 5, 30, 200, ("WHAT'S WRONG WITH\
YOU? WHAT DO YOU \
WANT? Oh I destroyed\
the entire forest? Who \
cares about that? What \
pleases me is far more \
important than the life \
in the forest. I am \
superior above all, you\
have to accept that."))

smlua_text_utils_dialog_replace(DIALOG_152, 1, 4, 30, 200, ("You did it! You killed an\
innocent wiggler who did\
nothing wrong, just so \
your greedy self can \
get a shiny object. You\
...
smlua_text_utils_dialog_replace(DIALOG_168, 1, 5, 30, 200, ("Oh so this is how you\
wanna play it? There is no\
escaping now. You are not\
gonna take my star and \
defeat me. YOU WILL DIE."))
