...
smlua_text_utils_dialog_replace(DIALOG_000,1,5,30,200, ("Welcome to another\
hack by Tomatobird8.\
This one has one level\
that is designed for\
single star speedruns.\
The stars are easy to get\
but the challenge lies\
in figuring out how to\
get the stars as quickly\
as possible!\
The in-game star grab\
timer code is injected\
into the rom. You do not\
need the timer code\
gameshark.\
For more convenient\
speedrun attempts, I\
have added a level reset\
code into the readme.txt\
...
level reset code.\
\
The readme will also\
include a link to a google\
doc with runners' best\
times on each star. You\
can submit your times to\
the leaderboard by\
messaging to Tomatobird8.\
Remember to record your\
attempts to a video so\
proof can be added to the\
google doc.\
\
...
smlua_text_utils_dialog_replace(DIALOG_008,1,5,30,200, ("It's recommended to\
set a savestate in the\
act select screen if\
you're not using the\
level select code.\
You can also set a\
savestate right when you\
press A to select an act\
in the act select screen.\
\
That way you won't have\
to press A every time\
you load a savestate.\
Just make sure you set\
the savestate before\
you enter the level (or\
before the level is\
visible.)\
\
\
...
star now requires\
only 60 coins. And\
there's also a box with\
an extra star, which\
makes the level have\
up to 8 stars!"))
...
smlua_text_utils_dialog_replace(DIALOG_013,1,5,30,200, ("You got the 60 coin\
star! I hope your time\
was also good!\
Save?\
//Yes////No"))
...
smlua_text_utils_dialog_replace(DIALOG_015,1,4,30,200, ("a"))
...
smlua_text_utils_dialog_replace(DIALOG_141,1,1,150,200, ("Potatoes are yummy."))

smlua_text_utils_dialog_replace(DIALOG_142,1,2,150,200, ("Sweet potatoes are\
yummy."))

smlua_text_utils_dialog_replace(DIALOG_143,1,1,150,200, ("How?"))
