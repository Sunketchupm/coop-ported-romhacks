vec3f_set(gLevelValues.starPositions.KoopaBobStarPos, 614, 1600, -10871)
...
vec3f_set(gLevelValues.starPositions.KingWhompStarPos, 4560.0, 2350.0, -52.0)
...
vec3f_set(gLevelValues.starPositions.PssSlideStarPos, 7677.0, 1710.0, 9592.0)
