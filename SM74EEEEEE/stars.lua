...
vec3f_set(gLevelValues.starPositions.KoopaThiStarPos, 1369, 144, -4779)
vec3f_set(gLevelValues.starPositions.KingBobombStarPos, -4570.0, 706.0, 5154.0)
vec3f_set(gLevelValues.starPositions.KingWhompStarPos, 430.0, 918.0, -4533.0)
...
vec3f_set(gLevelValues.starPositions.GhostHuntBooStarPos, 1355.0, 768.0, -4007.0)
...
vec3f_set(gLevelValues.starPositions.BalconyBooStarPos, 1355.0, 768.0, -4007.0)
