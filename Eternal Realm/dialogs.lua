smlua_text_utils_dialog_replace(DIALOG_000, 1, 3, 30, 200, ("How."))

smlua_text_utils_dialog_replace(DIALOG_001, 1, 5, 95, 200, ("Here, you can practice\
your QSLGs. (Quicksand\
Ledge Grabs) You are \
going to have to do a few\
in the challenge ahead of\
you, so I will teach you \
how to do them! You can\
practice with the green\
slowsand setup here!\
\
First: you must do a slow\
getup onto the ledge by\
holding towards where \
Mario is ledgegrabbing\
(Do not press A!)\
Next, while mario is in\
the getting up animation,\
hold NEUTRAL. Nothing \
should be held on your\
analog stick!\
Finally, just once mario\
is at the top of the ledge,\
press the A button,\
then a little after, hold\
a direction on your stick\
to direct mario where he\
needs to go! You have 7\
frames for this input, so\
it will just take some \
practice to time.\
You will know if you got\
the trick right with this\
slowsand practice setup\
if mario did a high jump\
instead of a low jump."))
...
smlua_text_utils_dialog_replace(DIALOG_003, 1, 1, 30, 200, ("Thank you, Mario! The Big\
...
smlua_text_utils_dialog_replace(DIALOG_004, 1, 1, 30, 200, ("We're peace-loving\
...
smlua_text_utils_dialog_replace(DIALOG_022, 1, 2, 95, 200, ("you can't enter here yet\
:( you can do it! :) :D"))
...
smlua_text_utils_dialog_replace(DIALOG_024, 1, 1, 30, 200, ("You need Star power to\
...
smlua_text_utils_dialog_replace(DIALOG_046, 1, 5, 30, 200, ("After you get the Wing\
Cap Switch on the opposite\
side of here, you will be\
able to get the wing cap\
over here and then go \
through the three holes.\
I will warn you, you have\
to go very fast for the\
two stars past there!"))

smlua_text_utils_dialog_replace(DIALOG_047, 1, 6, 95, 200, ("MARIO NO DON'T GO IN\
THIS CANNON NO\
PLEASE DON'T DO IT\
NO PLEASE NOOOOOOOOOO\
MARIO!!!!!!!!!! YOU WILL\
INSTANTLY DIE!!!! NOOOOOOOOOO"))

smlua_text_utils_dialog_replace(DIALOG_048, 1, 5, 30, 200, ("Hey, for this section, you\
should use a camera that\
faces this sign! There are\
arrows on that wall that\
will help you understand\
the section better! It is\
 also important to note,\
only press B when the \
wall tells you to at the\
end!"))
...
smlua_text_utils_dialog_replace(DIALOG_060, 1, 3, 30, 200, ("Did you know you keep\
more speed if you hold\
neutral upon twirling?\
This will be required for\
a future jump! Good luck\
on the bustle!"))

smlua_text_utils_dialog_replace(DIALOG_061, 1, 5, 30, 200, ("According to my\
calculations, we need 25\
STAR POWER to enter\
the VORTEX OF DOOM!\
crazy stuff!"))
...
smlua_text_utils_dialog_replace(DIALOG_067, 1, 6, 30, 200, ("It is us. The shells. We\
control the universe or\
something. We are why\
there is a VORTEX OF\
DOOM sucking all of the\
Eternal Realm's energy.\
We feast on that energy\
like no tomorrow. mmmmmm\
yum yum yum what\
yummy energy yum\
...
smlua_text_utils_dialog_replace(DIALOG_076, 1, 5, 30, 200, ("Yo what's good Mario!\
The view is pretty sauced\
up if I do say so myself.\
I'm just ignore the possible\
ramifications of the\
swirling vortex below me.\
I'm also gonna be willingly\
ignorant to the fact I \
exist in this tiny universe\
with literally nothing in \
it except for a few \
islands. Just kidding! We \
live in the Eternal \
Screalm bro, and I love it \
here! Anyway, I'm out!\
gonechamp"))
...
smlua_text_utils_dialog_replace(DIALOG_082, 1, 3, 30, 200, ("hiiiiiiii!!! i hope you get\
all the power ztars\
mario! :)\
...\
...\
...
...\
...\
did I say ztars... I meant\
stars! my bad! :D\
have fun mario! :)"))

smlua_text_utils_dialog_replace(DIALOG_083, 1, 3, 30, 200, ("If the other Toads didn't\
make you laugh, I surely\
will!"))

smlua_text_utils_dialog_replace(DIALOG_084, 1, 5, 30, 200, (""))
...
smlua_text_utils_dialog_replace(DIALOG_087, 1, 4, 30, 200, ("Welcome to the somebro\
slopes baby! If you have\
a perfectly axis aligned\
angle here, groundpound\
on the slope and hold\
neutral your whole way\
through, you will keep\
the same angle! Begin\
by wallkicking the plank,\
...
smlua_text_utils_dialog_replace(DIALOG_089, 1, 1, 95, 200, ("enjoy :D"))
...
smlua_text_utils_dialog_replace(DIALOG_154, 1, 5, 30, 200, ("what would capitalism\
be in a world where the\
letter c didn't exist?\
apitalism, snapitalism?\
maybe even kapitalism?"))

smlua_text_utils_dialog_replace(DIALOG_155, 1, 3, 30, 200, ("I'm lonely :(\
.\
.\
