smlua_text_utils_dialog_replace(DIALOG_000,1,3,30,200, ("There are 7 Stars in \
this level and it doesn't \
have 100s.\
\
It has 196s"))
...
smlua_text_utils_dialog_replace(DIALOG_015,1,5,30,200, ("Original level (used as \
OW in this hack) by \
Akuro. Edited level by\
MorningStorm. \
\
You can dive wallkick in \
the main level as well as \
wallkick out of most \
kinds of bonks (asm \
courtesy of ShiN3)."))
...
smlua_text_utils_dialog_replace(DIALOG_082,1,2,30,200, ("Imagine if this was just\
the beginning..."))
...
smlua_text_utils_dialog_replace(DIALOG_154,1,1,30,200, ("RainbowPls"))
