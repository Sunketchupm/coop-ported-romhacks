...
smlua_text_utils_dialog_replace(DIALOG_008,1,4,30,200, ("Yo, it's Gmd. This level\
started out as a level for\
a side project (TBD),\
but it got a bit more\
difficult than I was\
originally intending it to.\
Therefore, I decided to\
release it as its own 1\
level minihack because\
why not!\
...
smlua_text_utils_dialog_replace(DIALOG_010,1,4,30,200, ("Why did you bother\
checking this text?\
\
...
smlua_text_utils_dialog_replace(DIALOG_011,1,3,30,200, ("I'm honestly not sure\
how Mario doesn't\
just suffocate in metal.\
\
Would you like to Save?\
\
//Yes////No"))

smlua_text_utils_dialog_replace(DIALOG_012,1,3,30,200, ("I just wanted the\
overworld to look\
symmetrical, this cap\
has no purpose in this\
minihack.\
\
Kind of like an ice farm\
in Hawaii.\
\
Would you like to Save?\
\
...
smlua_text_utils_dialog_replace(DIALOG_018,1,4,30,200, ("This door just takes you\
to the end cake screen\
after you get all 7 stars.\
\
Because every hack\
needs an ending, right?"))
...
smlua_text_utils_dialog_replace(DIALOG_022,1,2,95,200, ("Finish the level 4Head"))
...
smlua_text_utils_dialog_replace(DIALOG_032,1,5,30,200, ("For this, be sure to face\
straight ahead, and\
ground pound on the\
slope.\
\
Afterwards, hold neutral\
...
smlua_text_utils_dialog_replace(DIALOG_039,1,4,30,200, ("Word of advice: Hit C-Up\
once to zoom the camera\
in a bit. It helps in this\
area quite a bit.\
Also, on the left, you'll\
pass right through that\
wall once you jump at it.\
good luck! :)"))
